// Yale-Mirador v0.7.3-23-g22c3f13 built Sun Oct 29 2017 23:47:53 GMT-0400 (EDT)
window._YaleMiradorVersion="Yale-Mirador v0.7.3-23-g22c3f13 built Sun Oct 29 2017 23:47:53 GMT-0400 (EDT)";
...
var registeredKeys = new Set(['annotationLayers', 'lastSelectedLayer', 'layerIndexMap']);
...
var StateStore = exports.StateStore = function () {
  function StateStore() {
...
exports.getApp = exports.App = undefined;
...
var App = exports.App = function () {
  ...
  _createClass(App, [{
    key: 'init',
    value: function () {
      var _ref = _asyncToGenerator(regeneratorRuntime.mark(function _callee(settings) {
        var grid;
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 5:
                ...
                grid = new _grid2.default(settings.ui.rootElementId);


                this._pageController = (0, _pageController2.default)();
    ...
    value: function _setupAnnotationTocCache() {
      var tocSpec = this._state.getSetting('annotations', 'tocSpec');
      if (tocSpec) {
    ...
    value: function getAnnotationSource() {
      if (!annotationSource) {
        var annoStoreUrl = this._state.getSetting('annotations', 'store');
...
var getApp = exports.getApp = function getApp() {
  if (!instance) {
    instance = new App();
  }
  return instance;
  ...
  _createClass(PageController, [{
    ...
    value: function () {
      var _ref = _asyncToGenerator(regeneratorRuntime.mark(function _callee(windowId, annoId) {
        var grid, windowProxy, canvasId, annotations, annotation, layerId, derivedAnnotation, targetWindow, annoWindow;
        return regeneratorRuntime.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                logger.debug('PageController#showAnnotation windowId:', windowId, 'annoId:' + annoId, 'defaultLayer:', this._tocSpec ? this._tocSpec.defaultLayer : null);
                grid = this.options.grid;
              ...
              case 15:
                targetWindow = grid.getAnnotationWindowByLayer(layerId);
    ...
    value: function _processUrlOptions(imageWindowId, options) {
      ...
      if (this._urlOptionsProcessed) {
        ...
        if (this.options.state.getSetting('mirador', 'annotationsOverlay', 'showByDefault') || options.annotationId) {
          this._miradorProxy.publish('YM_DISPLAY_ON');
        }
    ...
    value: function _bindEvents(options) {
      ...
      jQuery.subscribe('ANNOWIN_ANNOTATION_FOCUSED', function (event, params) {
        ...
        var canvasId = windowProxy.getCurrentCanvasId();
        ...
        if (params.canvasId === windowProxy.getCurrentCanvasId()) {
          ...
          if (!_import.annoUtil.hasTargetOnCanvas(anno)) {
            var annos = _this3._findCanvasAnnotationsFromTargets(anno, annotations, canvasId);
            anno = annos[0];
          }
          if (anno) {
      ...
      jQuery.subscribe('YM_ANNOTATION_TOC_TAGS_SELECTED', function () {
        var _ref4 = _asyncToGenerator(regeneratorRuntime.mark(function _callee4(evnet, windowId, canvasId, tags) {
          var grid, layerId, annoWindow, annotationWindows, _iteratorNormalCompletion4, _didIteratorError4, _iteratorError4, _iterator4, _step4, annoWin;
            ...
            while (1) {
              switch (_context4.prev = _context4.next) {
                case 0:
                  ...
                  _this3._miradorProxy.publish('YM_DISPLAY_ON');
                ...
                case 13:
                  annotationWindows = _this3.options.grid.getAnnotationWindows();
                  _iteratorNormalCompletion4 = true;
                  _didIteratorError4 = false;
                  _iteratorError4 = undefined;
                  _context4.prev = 17;

                  for (_iterator4 = Object.values(annotationWindows)[Symbol.iterator](); !(_iteratorNormalCompletion4 = (_step4 = _iterator4.next()).done); _iteratorNormalCompletion4 = true) {
                    annoWin = _step4.value;
          ...
          }, _callee4, _this3, [[4, 10], [17, 21, 25, 33], [26,, 28, 32]]);
        }));
...
var _modalAlert = __webpack_require__(11);
...
var AnnotationSource = function () {
  ...
  _createClass(AnnotationSource, [{
    ...
    value: function _getRemoteLayers() {
      ...
      return new Promise(function (resolve, reject) {
        var projectId = _this._state.getSetting('auth', 'groupId');
        var url = _this._prefix + '/layers';
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              ...
              case 4:
                ...
                annotations = null;
                _context2.next = 8;
                return (0, _modalAlert2.default)().show('Retrieving annotations...');
    ...
    value: function _getRemoteAnnotations(canvasId) {
      ...
      return new Promise(function (resolve, reject) {
        var url = _this2._prefix + '/getAnnotationsViaList?canvas_id=' + encodeURIComponent(canvasId);
          ...
          while (1) {
            switch (_context8.prev = _context8.next) {
              ...
              case 3:
                ...
                url = this._prefix + '/' + annotationId.replace(/^https?:\/\/.*?(\/.*)$/, '$1');
          ...
          while (1) {
            switch (_context10.prev = _context10.next) {
              ...
              case 2:
                ...
                url = this._prefix + '/resequenceList';
                data = {
                  canvas_id: canvasId,
                  layer_id: layerId,
...
var _errorDialog = __webpack_require__(51);
  ...
  _createClass(AnnotationEditor, [{
    ...
    value: function bindEvents() {
      ...
      this.element.find('.ym_cancel').click(function (event) {
        ...
        _this3.destroy();
        if (typeof _this3.cancelCallback === 'function') {
          _this3.cancelCallback();
        }
      });

      this.element.find('.ym_vertical_inc').click(function (event) {
        var iframeId = _this3.getEditor().id + '_ifr';
...
var DomHelper = function () {
  ...
  _createClass(DomHelper, [{
    ...
    key: 'getLayerSelectorContainer',
    value: function getLayerSelectorContainer() {
      return this._layerSelectorContainer;
    }
  }, {
    key: 'getTocTagSelector',
    value: function getTocTagSelector() {
      return this._tocTagSelector;
    }
  }, {
    key: 'getOrderConfirm',
    value: function getOrderConfirm() {
      return this._orderConfirm;
    }
  }, {
    key: 'getSaveOrderButton',
    value: function getSaveOrderButton() {
      return this._saveOrderButton;
    }
  }, {
    key: 'getCancelOrderButton',
    value: function getCancelOrderButton() {
      return this._cancelOrderButton;
    }
  }, {
    key: 'getCreateWindowButton',
    value: function getCreateWindowButton() {
      return this._createWindowButton;
    }
  }, {
    key: 'getToggleDirectionButton',
    value: function getToggleDirectionButton() {
    ...
    key: 'getAllAnnotationCells',
    value: function getAllAnnotationCells() {
      return this.getListContainer().find('.annowin_anno').toArray();
    }
  }, {
    key: '_findOne',
    value: function _findOne(root, selector) {
      var found = root.find(selector);
      return found.length > 0 ? jQuery(found[0]) : null;
    }
  }, {
    key: 'findAnnoListElem',
    value: function findAnnoListElem(rootElem) {
    ...
    key: 'isAnnotationCell',
    value: function isAnnotationCell(elem) {
      return elem.hasClass('annowin_anno');
    }
  }, {
    key: 'findAnnoElemByAnnoId',
    value: function findAnnoElemByAnnoId(annoId) {
      var _iteratorNormalCompletion = true;
      var _didIteratorError = false;
      var _iteratorError = undefined;

      try {
        for (var _iterator = this.getAllAnnotationCells()[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
    ...
    value: function updateDirection() {
      var rowReverse = this._root.hasClass('row-reverse');
    ...
    key: '_addCreateWindowButton',
    value: function _addCreateWindowButton() {
      var parent = this._root.find('.annowin_layer_row .right');
    ...
    key: '_addToggleDirectionButton',
    value: function _addToggleDirectionButton() {
      var parent = this._root.find('.annowin_layer_row .right');
      var button = jQuery('<div/>').addClass('ym_toggle_direction_button').append(jQuery('<i class="fa fa-arrows-h fa-lg fa-fw"></i>')).append(jQuery('<i class="fa fa-arrows-v fa-lg fa-fw"></i>'));
...
var _class = function () {
  ...
  _createClass(_class, [{
    ...
    value: function init(layers) {
      ...
      var hiddenLayers = this.appState.getSetting('ui', 'annotationWindow', 'hiddenLayers') || [];
...
window.YaleMirador = {
  getApp: _app2.default,
  fatalError: _fatalError2.default
};
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(57), __webpack_require__(56)))
...
var MiradorConfigBuilder = function () {
  function MiradorConfigBuilder(options) {
    ...
    var window = this._state.getSetting('initialLayout', 'windows')[0];
  ...
  _createClass(MiradorConfigBuilder, [{
    ...
    value: function buildConfig() {
      var config = jQuery.extend(true, {}, this._options.defaultSettings);
      var tocSpec = this._state.getSetting('annotations', 'tocSpec');
      ...
      jQuery.extend(config, {
        ...
        i18nAdditions: new _locales2.default().getLocalesConfig(this._options)
      });
      ...
      var hoverColor = this._state.getSetting('mirador', 'annotationsOverlay', 'hoverColor');
      var hoverWidthFactor = this._state.getSetting('mirador', 'annotationsOverlay', 'hoverWidthFactor');
...
var AnnotationTableOfContents = function () {
  ...
  _createClass(AnnotationTableOfContents, [{
    ...
    value: function init() {
      var _this = this;
      var tocSpec = (0, _stateStore2.default)().getSetting('annotations', 'tocSpec');
...
(function ($) {
  ...
  jQuery.extend($.yaleExt, {
    ...
    updateTooltipStyles: function updateTooltipStyles() {
      ...
      var styles = (0, _stateStore2.default)().getSetting('mirador', 'tooltipStyles');
      if (styles) {
...
(function ($) {
  ...
  $.Manifest.prototype.processCopyright = function (jsonLd) {
    ...
    if ((0, _stateStore2.default)().getSetting('auth', 'images', 'copyrighted')) {
      copyrightedImageServiceUrl = (0, _stateStore2.default)().getSetting('auth', 'images', 'altImageService');
...
(function ($) {
            ...
            try {
              for (var _iterator3 = annotations[Symbol.iterator](), _step3; !(_iteratorNormalCompletion3 = (_step3 = _iterator3.next()).done); _iteratorNormalCompletion3 = true) {
                ...
                if (shape.data.annotation['@id'] === annotation['@id']) {
                  ...
                  shape.sendToBack();
                  var hide = (0, _stateStore2.default)().getSetting('mirador', 'annotationsOverlay', 'hideUnfocused');
                  if (hide) {
                    shape.opacity = 0;
                  } else {
                    shape.opacity = 1;
  ...
  $.OsdRegionDrawTool.prototype.highlightShape = function (shape) {
    ...
    var hoverColor = state.getSetting('mirador', 'annotationsOverlay', 'hoverColor');
    var hoverWidthFactor = state.getSetting('mirador', 'annotationsOverlay', 'hoverWidthFactor');
...
var _annotationWindow = __webpack_require__(46);
  ...
  _createClass(_class, [{
    ...
    value: function initLayout() {
      ...
      this._layout.registerComponent('Mirador', function (container, componentState) {
        ...
        var miradorElem = jQuery('<div/>').attr('id', componentState.miradorId);
    ...
    value: function () {
      var _ref = _asyncToGenerator(regeneratorRuntime.mark(function _callee(options) {
        var windowId, imageWindowId, itemConfig, annoExplorer, annoWin;
        return regeneratorRuntime.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
              ...
              case 3:
                ...
                annoExplorer = (0, _app2.default)().getAnnotationExplorer();

                // Just taking the first (highest-level) tag, for now

                annoWin = new _annotationWindow2.default({
                  id: windowId,
      ...
      function addAnnotationWindow(_x) {
        return _ref.apply(this, arguments);
      }

      return addAnnotationWindow;
    }()
  }, {
    ...
    key: 'getAnnotationWindowByLayer',
    value: function getAnnotationWindowByLayer(layerId) {
...
var MiradorWrapper = function () {
  ...
  _createClass(MiradorWrapper, [{
    ...
    key: 'zoomToTags',
    value: function () {
      var _ref = _asyncToGenerator(regeneratorRuntime.mark(function _callee(windowId, canvasId, tags) {
        var _this = this;

        var tocCache, toc, windowProxy, imageView, tocNode, annotation, zoomToAnnotation;
        return regeneratorRuntime.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
              ...
              case 4:
                ...
                annotation = tocNode.canvasAnnotations[0];
                ...
                return _context.abrupt('return', new Promise(function (resolve, reject) {
                  var handler = function handler(event) {
                    ...
                    zoomToAnnotation();
                    _this._miradorProxy.unsubscribe('annotationsRendered.' + windowId, handler);
                    resolve();
                  };
                  ...
                  if (canvasId === windowProxy.getCurrentCanvasId()) {
                    ...
                    _this._miradorProxy.subscribe('annotationsRendered.' + windowId, handler);
      ...
      function zoomToTags(_x, _x2, _x3) {
        return _ref.apply(this, arguments);
      }
...
var _annotationNav = __webpack_require__(45);

var _annotationNav2 = _interopRequireDefault(_annotationNav);

var _annotationPageRenderer = __webpack_require__(47);
...
var _scrollHelper = __webpack_require__(50);
...
var AnnotationListWidget = function () {
  function AnnotationListWidget(options) {
    ...
    if (!this._annoPageRenderer) {
      this._annoPageRenderer = new _annotationPageRenderer2.default({
  ...
  _createClass(AnnotationListWidget, [{
    ...
    key: 'getAnnotationElems',
    value: function getAnnotationElems() {
    ...
    value: function reload(layerId) {
      ...
      this._scrollHelper = new _scrollHelper2.default({
        listWidget: this,
    ...
    value: function _setupNavigation() {
      var nav = new _annotationNav2.default({
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                _context.next = 5;
                return this._onNavSetPage(pageNum).catch(function (reason) {
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                ...
                _context2.next = 4;
                return this.goToPage(pageNum).catch(function (reason) {
    ...
    key: 'goToPageByTags',
    value: function () {
      var _ref3 = _asyncToGenerator(regeneratorRuntime.mark(function _callee3(tags) {
        var canvasIds;
        return regeneratorRuntime.wrap(function _callee3$(_context3) {
          while (1) {
            switch (_context3.prev = _context3.next) {
    ...
    value: function () {
      ...
      function goToAnnotation(_x4, _x5) {
        return _ref4.apply(this, arguments);
      }
    ...
    key: '_onNavSetPage',
    value: function () {
      var _ref5 = _asyncToGenerator(regeneratorRuntime.mark(function _callee5(pageNum) {
        var canvas, oldCanvasId, newCanvasId;
        return regeneratorRuntime.wrap(function _callee5$(_context5) {
          while (1) {
            switch (_context5.prev = _context5.next) {
              case 0:
                logger.debug('AnnotationListWidget#_onNavSetPage pageNum:', pageNum);
                canvas = this._nav.getCanvas(pageNum);
                ...
                _context5.next = 8;
                return this._loadPage(pageNum).catch(function (reason) {
              ...
              case 13:
                _context5.next = 15;
                return this._scrollHelper.scrollToPage(pageNum);

              case 15:

                if (oldCanvasId !== newCanvasId) {
                  // if the focused annotation belongs to a different canvas
      ...
      function _onNavSetPage(_x6) {
        return _ref5.apply(this, arguments);
      }

      return _onNavSetPage;
    }()
        ...
        return regeneratorRuntime.wrap(function _callee6$(_context6) {
          while (1) {
            switch (_context6.prev = _context6.next) {
              ...
              case 4:
                this._loading = true;
                nextPage = this._nav.getActiveRange().endPage + 1;
              ...
              case 12:
                ...
                logger.error('AnnotationListWidget#loadNextPages failed', _context6.t0);
        ...
        return regeneratorRuntime.wrap(function _callee7$(_context7) {
          while (1) {
            switch (_context7.prev = _context7.next) {
              ...
              case 4:
                this._loading = true;
                nextPage = this._nav.getActiveRange().startPage - 1;
              ...
              case 12:
                ...
                logger.error('AnnotationListWidget#loadNextPages failed', _context7.t0);
    ...
    value: function () {
      var _ref8 = _asyncToGenerator(regeneratorRuntime.mark(function _callee8() {
        var minHeight, numPages, scrollHeight, nextPage;
        return regeneratorRuntime.wrap(function _callee8$(_context8) {
          while (1) {
            switch (_context8.prev = _context8.next) {
              case 0:
              ...
              case 4:
                this._loading = true;
                minHeight = this._rootElem.height() * this._minContentRelativeHeight;
                numPages = this._nav.getNumPages();
                scrollHeight = this._rootElem[0].scrollHeight;
                nextPage = this._nav.getActiveRange().endPage + 1;

              case 9:
                if (!(nextPage < numPages && scrollHeight < minHeight)) {
                  _context8.next = 16;
                  break;
                }
              ...
              case 18:
                ...
                logger.error('AnnotationListWidget#loadNextPages failed', _context8.t0);
        ...
        return regeneratorRuntime.wrap(function _callee9$(_context9) {
          while (1) {
            switch (_context9.prev = _context9.next) {
              ...
              case 9:
                if (!(nextPage >= 0 && scrollHeight < minHeight)) {
                  _context9.next = 16;
                  break;
                }
              ...
              case 18:
                ...
                logger.error('AnnotationListWidget#loadPreviousPages failed', _context9.t0);
    ...
    value: function clearAnnotationHighlights() {
      ...
      try {
        for (var _iterator = this._dom.getAllAnnotationCells()[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
    ...
    value: function highlightAnnotations(annotations, flag) {
      ...
      try {
        for (var _iterator2 = this._dom.getAllAnnotationCells()[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
    ...
    value: function highlightAnnotation(annoId, flag) {
      var _iteratorNormalCompletion4 = true;
      var _didIteratorError4 = false;
      var _iteratorError4 = undefined;

      try {
        for (var _iterator4 = this._dom.getAllAnnotationCells()[Symbol.iterator](), _step4; !(_iteratorNormalCompletion4 = (_step4 = _iterator4.next()).done); _iteratorNormalCompletion4 = true) {
          var annoElem = _step4.value;
    ...
    key: 'highlightAnnotationElem',
    value: function highlightAnnotationElem(annoElem, flag) {
    ...
    value: function _createPageElements() {
      ...
      var nav = this._nav;
      var pageRenderer = this._annoPageRenderer;

      for (var pageNum = 0; pageNum < this._canvases.length; ++pageNum) {
        var canvas = nav.getCanvas(pageNum);
    ...
    value: function () {
      var _ref10 = _asyncToGenerator(regeneratorRuntime.mark(function _callee10(pageNum, numPages) {
      ...
      function _activateMorePagesForward(_x7, _x8) {
        return _ref10.apply(this, arguments);
      }
    ...
    value: function () {
      ...
      function _activateMorePagesBackward(_x9) {
    ...
    key: '_loadPage',
    value: function () {
      var _ref12 = _asyncToGenerator(regeneratorRuntime.mark(function _callee12(pageNum) {
        var annotations, toc, element;
        return regeneratorRuntime.wrap(function _callee12$(_context12) {
          while (1) {
            switch (_context12.prev = _context12.next) {
              ...
              case 6:
                annotations = _context12.sent;
                _context12.next = 9;
                return this._getTocForPage(pageNum);

              case 9:
                toc = _context12.sent;
                element = this._nav.getPageElement(pageNum);
    ...
    value: function _unloadAllPages() {
      ...
      try {
        for (var _iterator5 = this._nav.getPageElements()[Symbol.iterator](), _step5; !(_iteratorNormalCompletion5 = (_step5 = _iterator5.next()).done); _iteratorNormalCompletion5 = true) {
    ...
    value: function _unloadNextPages() {
      ...
      var maxHeight = this._maxContentRelativeHeight * rootElemHeight;

      for (var nextPage = nav.getActiveRange().endPage; nextPage > nav.getPage() + 1 && rootElem[0].scrollHeight - rootElemHeight > maxHeight; --nextPage) {
    ...
    value: function () {
          ...
          while (1) {
            switch (_context13.prev = _context13.next) {
              case 0:
                ...
                _context13.next = 5;
                return tocCache.getToc(canvas['@id']);
      ...
      function _getTocForPage(_x11) {
        return _ref13.apply(this, arguments);
      }

      return _getTocForPage;
    }()
  }, {
    key: '_getAnnotationsForPage',
    value: function () {
      var _ref14 = _asyncToGenerator(regeneratorRuntime.mark(function _callee14(pageNum) {
        var _this2 = this;

        var canvasId, annotations;
        return regeneratorRuntime.wrap(function _callee14$(_context14) {
          while (1) {
            switch (_context14.prev = _context14.next) {
              case 0:
                canvasId = this._nav.getCanvas(pageNum)['@id'];
                _context14.next = 3;
                return this._annoExplorer.getAnnotations({
                  canvasId: canvasId
                });

              case 3:
                annotations = _context14.sent;
                return _context14.abrupt('return', annotations.filter(function (anno) {
                  return anno.layerId === _this2._layerId;
                }));
      ...
      function _getAnnotationsForPage(_x12) {
        return _ref14.apply(this, arguments);
      }

      return _getAnnotationsForPage;
    }()
  }, {
    key: 'clearHighlights',
    value: function clearHighlights() {
      ...
      try {
        for (var _iterator6 = this._dom.getAllAnnotationCells()[Symbol.iterator](), _step6; !(_iteratorNormalCompletion6 = (_step6 = _iterator6.next()).done); _iteratorNormalCompletion6 = true) {
          var cell = _step6.value;

          jQuery(cell).removeClass('annowin_targeted').removeClass('ym_anno_selected ym_anno_targeting ym_anno_targeted');
        }
      } catch (err) {
        _didIteratorError6 = true;
        _iteratorError6 = err;
    ...
    value: function getTocSiblingElems(annotation, annotations, layerId, toc) {
      ...
      try {
        for (var _iterator7 = this._dom.getAllAnnotationCells()[Symbol.iterator](), _step7; !(_iteratorNormalCompletion7 = (_step7 = _iterator7.next()).done); _iteratorNormalCompletion7 = true) {
          var annoElem = _step7.value;
          ...
          try {
            for (var _iterator8 = siblings[Symbol.iterator](), _step8; !(_iteratorNormalCompletion8 = (_step8 = _iterator8.next()).done); _iteratorNormalCompletion8 = true) {
        ...
        return regeneratorRuntime.wrap(function _callee15$(_context15) {
          while (1) {
            switch (_context15.prev = _context15.next) {
              case 0:
                nav = this._nav;
                current = jQuery(this._rootElem.find('.annowin_anno:focus'));
                next = current.next();
    ...
    value: function scrollToAnnotation(annoId, yOffset) {
...
var AnnotationNav = function () {
  function AnnotationNav(options) {
    _classCallCheck(this, AnnotationNav);
  ...
  _createClass(AnnotationNav, [{
    ...
    key: 'setPageByCanvasId',
    value: function setPageByCanvasId(canvasId) {
    ...
    value: function getPageElements() {
      return this._pageStateList.map(function (item) {
        return item.element;
      });
    }
  }, {
    key: 'getPageElement',
    value: function getPageElement(pageNum) {
      return this._pageStateList[pageNum].element;
    }
  }, {
    key: 'setPageElement',
    value: function setPageElement(pageNum, elem) {
      this._pageStateList[pageNum].element = elem;
    }
  }, {
    key: 'getCanvas',
    value: function getCanvas(pageNum) {
      return this._pageStateList[pageNum].canvas;
    }
  }, {
    key: 'isLoaded',
    value: function isLoaded(pageNum) {
      return this._pageStateList[pageNum].loaded;
    }
  }, {
    key: 'setLoaded',
    value: function setLoaded(pageNum) {
      this._pageStateList[pageNum].loaded = true;
    }
  }, {
    key: 'load',
    value: function load(pageNum, annotations, toc) {
    ...
    key: '_removeFromActiveRange',
    value: function _removeFromActiveRange(pageNum) {
    ...
    key: 'getPageNumForCanvas',
    value: function getPageNumForCanvas(canvasId) {
      for (var i = 0; i < this._pageStateList.length; ++i) {
        if (this._pageStateList[i].canvas['@id'] === canvasId) {
          return i;
        }
...
var _annotationListWidget = __webpack_require__(44);
...
var _menuTagSelector = __webpack_require__(52);
...
var AnnotationWindow = function () {
  function AnnotationWindow(options) {
    ...
    this._miradorProxy = (0, _miradorProxyManager2.default)().getMiradorProxy(this._miradorId);
    this._tocSpec = (0, _stateStore2.default)().getSetting('annotations', 'tocSpec');
    this._annotationTocCache = (0, _app2.default)().getAnnotationTocCache();
    ...
    this._dom = new _domHelper2.default(this._appendTo);
  ...
  _createClass(AnnotationWindow, [{
    ...
    value: function () {
      var _ref = _asyncToGenerator(regeneratorRuntime.mark(function _callee() {
        var canvasId, annotationList, toc, _processDataParams2, targetAnno, layerId, tocTags;
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                annotationList = this._imageWindow.getAnnotationsList();
              ...
              case 9:
                ...
                }), targetAnno = _processDataParams2.targetAnno, layerId = _processDataParams2.layerId, tocTags = _processDataParams2.tocTags;
    ...
    key: 'ignoreEvent',
    value: function ignoreEvent(eventId, duration) {
      this._ignoredEvents[eventId] = new Date().valueOf() + duration;
    }
  }, {
    key: '_shouldIgnoreEvent',
    value: function _shouldIgnoreEvent(eventId) {
      var expiration = this._ignoredEvents[eventId];
    ...
    key: '_processDataParams',
    value: function _processDataParams(params) {
      logger.debug('AnnotationWindow#_processDataParams params:', params);
      var targetAnno = null; // annotation that should be visible and focused on
      var layerId = params.layerId;
      var tocTags = params.tocTags;

      if (params.annotationId) {
        // annotationId is given the highest priority in determining targetAnno
        targetAnno = _import.annoUtil.findAnnotationFromListById(params.annotationId, params.annotationList);
    ...
    key: '_getTargetAnnoWithToc',
    value: function _getTargetAnnoWithToc(annotationList, layerId, toc, tocTags) {
      var annosToShow = annotationList.filter(function (anno) {
        return anno.layerId == layerId;
      }).filter(function (anno) {
        return toc.matchHierarchy(anno, tocTags.slice(0, 1));
      });
      var fullTagsTargets = annosToShow.filter(function (anno) {
        return toc.matchHierarchy(anno, tocTags);
      });
    ...
    key: '_processAnnotationId',
    value: function _processAnnotationId(params) {
      var targetAnno = _import.annoUtil.findAnnotationFromListById(params.annotationId, params.annotationList)[0];
      var layerId = params.layerId;
      var tocTags = [];
    ...
    key: '_processLayerId',
    value: function _processLayerId(layerId, annotationList, toc, tocTags) {
      var _this2 = this;

      var annosToShow = annotationList.filter(function (anno) {
        return anno.layerId == _this2._initialLayerId;
      });
    ...
    value: function _setupAnnotationListWidget() {
      if (!this._listWidget) {
        var windowProxy = (0, _miradorProxyManager2.default)().getWindowProxyById(this._imageWindowId);
        var canvases = windowProxy.getManifest().getCanvases();

        this._listWidget = new _annotationListWidget2.default({
    ...
    value: function initMenuTagSelector() {
      ...
      this.menuTagSelector = new _menuTagSelector2.default({
        ...
        tocSpec: (0, _stateStore2.default)().getSetting('annotations', 'tocSpec'),
        annotationExplorer: this._explorer,
              ...
              while (1) {
                switch (_context2.prev = _context2.next) {
                  case 0:
                    ...
                    _context2.next = 3;
                    return _this3._listWidget.goToPageByTags([value]);
    ...
    value: function initLayerSelector() {
      ...
      this.layerSelector = new _layerSelector2.default({
        ...
        changeCallback: function changeCallback(value, text) {
          ...
          _this4._setCurrentLayerId(value);
          _this4.updateList();
        }
      });
    }
    ...
    value: function _toggleDirection() {
      var root = this._dom.getRoot();
    ...
    key: '_setDirty',
    value: function _setDirty(value) {
      this._dirty = value;
    }
  }, {
    key: 'reload',
    value: function reload() {
      ...
      return Promise.all([layersPromise, tocPromise]).then(_asyncToGenerator(regeneratorRuntime.mark(function _callee3() {
        return regeneratorRuntime.wrap(function _callee3$(_context3) {
          while (1) {
            switch (_context3.prev = _context3.next) {
              case 0:
                _context3.next = 2;
                return _this5.updateList().catch(function (reason) {
                  throw 'AnnotationWindow#updateList failed: ' + reason;
                });

              case 2:
                _this5._dom.updateDirection();
                _this5.show();
            ...
            switch (_context4.prev = _context4.next) {
              case 0:
                ...
                */
                ...
                _context4.next = 6;
                return listWidget.reload(this.layerSelector.val());
              ...
              case 6:
                ...
                _context4.next = 10;
                return listWidget.goToPageByTags(this._initialTocTags).catch(function (reason) {
                  throw 'listWidget#goToPageByTags failed: ' + reason + '(tags: ' + _this6._initialTocTags + ')';
                });
              ...
              case 14:
                _context4.next = 16;
                return listWidget.goToPageByCanvas(canvasId).catch(function (reason) {
    ...
    value: function getCurrentCanvas() {
      ...
      var canvases = this._imageWindow.getManifest().getCanvases();
          ...
          while (1) {
            switch (_context5.prev = _context5.next) {
              case 0:
                ...
                return _context5.abrupt('return', this._listWidget.goToAnnotation(annoId, canvasId));
    ...
    key: 'showSaveOrderConfirmation',
    value: function showSaveOrderConfirmation(pageElem) {
    ...
    value: function _saveAnnotationsOrder(pageElem) {
      ...
      return this._explorer.updateAnnotationListOrder(canvasId, layerId, annoIds).catch(function (reason) {
        _this7._dom.getOrderConfirm().hide();
        var msg = 'AnnotationWindow#_saveAnnotationsOrder updateAnnotationListOrder failed: ' + reason;
        throw msg;
      });
    }
  }, {
    ...
    value: function bindEvents() {
      ...
      this._dom.getCreateWindowButton().click(function (event) {
        _this8._miradorProxy.publish('YM_DISPLAY_ON');
        jQuery.publish('YM_ADD_WINDOW', {
          miradorId: _this8._miradorId,
          imageWindowId: _this8._imageWindowId
        });
      });

      this._dom.getToggleDirectionButton().click(function (event) {
        _this8._toggleDirection();
      });

      this._dom.getSaveOrderButton().click(function (event) {
        _this8._saveAnnotationsOrder(_this8._reorderedPageElem);
        _this8._dom.getOrderConfirm().hide();
      });

      this._dom.getCancelOrderButton().click(function (event) {
        _this8._dom.getOrderConfirm().hide();
      });

      this._subscribe(this._miradorProxy, 'ANNOTATIONS_LIST_UPDATED', function (event, params) {
        logger.debug('AnnotationWindow:SUB:ANNOTATIONS_LIST_UPDATED, params:', params);
        if (params.windowId === _this8.getImageWindowId() && !_this8._shouldIgnoreEvent('ANNOTATIONS_LIST_UPDATED')) {
          if (_this8.hasOpenEditor()) {
            _this8._setDirty(true);
          } else {
            _this8.reload();
          }
        }
      ...
      this._subscribe(jQuery, 'ANNOWIN_ANNOTATION_FOCUSED', function () {
        var _ref6 = _asyncToGenerator(regeneratorRuntime.mark(function _callee6(event, params) {
          var $anno, listWidget, targetElem, annotations, layerId, tocSpec, _toc, siblingElems, _iteratorNormalCompletion2, _didIteratorError2, _iteratorError2, _iterator2, _step2, elem, annoMap, _iteratorNormalCompletion3, _didIteratorError3, _iteratorError3, _iterator3, _step3, anno, targeting, targeted;
            ...
            while (1) {
              switch (_context6.prev = _context6.next) {
                case 0:
                  ...
                  if (!(params.annotationWindowId === _this8._id)) {
                    _context6.next = 6;
                    break;
                  }
                ...
                case 6:
                  ...
                  annotations = _this8._imageWindow.getAnnotationsList();
                  layerId = _this8.getCurrentLayerId();
                  tocSpec = (0, _stateStore2.default)().getSetting('annotations', 'tocSpec');
                ...
                case 13:
                  _toc = _context6.sent;
                  siblingElems = listWidget.getTocSiblingElems(params.annotation, annotations, layerId, _toc);
                  ...
                  _context6.prev = 19;
                  for (_iterator2 = siblingElems[Symbol.iterator](); !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
                    elem = _step2.value;
                ...
                case 62:
                  ...
                  targeting = targeting.filter(function (anno) {
                    return anno.layerId === _this8.getCurrentLayerId();
                  });
                  ...
                  targetElem = _this8._dom.findAnnoElemByAnnoId(targeting[0]['@id']);
                ...
                case 69:
                  ...
                  targetElem = _this8._dom.findAnnoElemByAnnoId(targeted[0]['@id']);
                  listWidget.scrollToElem(targetElem, -params.offset);
                  return _context6.abrupt('return');
          ...
          }, _callee6, _this8, [[19, 23, 27, 35], [28,, 30, 34], [46, 50, 54, 62], [55,, 57, 61]]);
        }));
      ...
      this._subscribe(this._miradorProxy, 'YM_IMAGE_WINDOW_TOOLTIP_ANNO_CLICKED', function () {
        var _ref7 = _asyncToGenerator(regeneratorRuntime.mark(function _callee7(event, windowId, annoId) {
          var windowProxy, canvasId, _toc2, annotation;

          return regeneratorRuntime.wrap(function _callee7$(_context7) {
            while (1) {
              switch (_context7.prev = _context7.next) {
                case 0:
                  logger.debug('AnnotationWindow:SUB:YM_IMAGE_WINDOW_TOOLTIP_ANNO_CLICKED windowId:', windowId, 'annoId:', annoId, 'annoWin:', _this8.id);
                  windowProxy = _this8._miradorProxy.getWindowProxyById(windowId);
                  canvasId = windowProxy.getCurrentCanvasId();

                  if (!_this8._continuousPages) {
                    _context7.next = 11;
                    break;
                  }

                  _context7.next = 6;
                  return _this8._annotationTocCache.getToc(canvasId);

                case 6:
                  _toc2 = _context7.sent;
                  annotation = _toc2.annotations.filter(function (anno) {
                    return anno['@id'] === annoId;
                  })[0];


                  if (annotation) {
                    _this8._listWidget.goToPageByTags(annotation.tocTags);
                  }
                  _context7.next = 12;
                  break;

                case 11:
                  _this8._listWidget.goToAnnotation(annoId, canvasId);
    ...
    value: function _unsubscribeAll() {
      var _arr = [jQuery, this._miradorProxy];
...
var _annotationRenderer = __webpack_require__(48);

var _annotationRenderer2 = _interopRequireDefault(_annotationRenderer);

var _annotationTocRenderer = __webpack_require__(49);
...
var AnnotationPageRenderer = function () {
  function AnnotationPageRenderer(options) {
    ...
    if (!this._annoRenderer) {
      this._annoRenderer = new _annotationRenderer2.default({
        annotationWindow: this._annoWin,
        state: this._state
      });
    }
        ...
        for (var _iterator = options.annotations[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
          ...
          try {
            if (annotation.layerId === layerId) {
              ++count;
              var annoElem = this._annoRenderer.createAnnoElem(annotation, {
                pageElem: pageElem,
                canvasId: canvasId,
...
var pageTemplate = Handlebars.compile(['<div class="ym-annotation-page page-{{pageNum}}">', '  <div class="page-header">{{text}}', '  </div>', '</div>'].join(''));
  ...
  _createClass(AnnotationRenderer, [{
    ...
    value: function bindAnnotationItemEvents(annoElem, annotation, options) {
      ...
      annoElem.find('.edit').click(function (event) {
        var dom = _this._annoWin.getDomHelper();
...
var annotationTemplate = Handlebars.compile(['<div class="annowin_anno" tabindex="-1">', '  <div class="normal_view">', '    {{#if isEditor}}', '      <div class="menu_bar">', '        <div class="ui text menu">', '          <div class="ui dropdown item">',
//'            Action<i class="dropdown icon"></i>',
'            <i class="fa fa-bars fa-fw"></i>', '            <div class="menu">', '              <div class="annotate item"><i class="fa fa-hand-o-left fa-fw"></i> Annotate</div>', '              <div class="edit item"><i class="fa fa-edit fa-fw"></i> {{t "edit"}}</div>', '              <div class="delete item"><i class="fa fa-times fa-fw"></i> {{t "delete"}}</div>', '            </div>', '          </div>', '          {{#if orderable}}', '            <div class="right menu">', '              <i class="order-down caret down icon"></i>', '              <i class="order-up caret up icon"></i>', '            </div>', '          {{/if}}', '        </div>', '      </div>', '    {{/if}}', '    <div class="content">{{{content}}}</div>', '    <div class="tags">{{{tags}}}</div>', '  </div>', '</div>'].join(''));
...
var AnnotationTocRenderer = function () {
  ...
  _createClass(AnnotationTocRenderer, [{
    ...
    value: function appendAnnotations(node) {
      ...
      try {
        for (var _iterator = node.annotations[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
          var anno = _step.value;

          if (anno.layerId === this.options.layerId) {
            var annoElem = renderer.createAnnoElem(anno, {
              pageElem: pageElem,
              canvasId: pageElem.data('canvasId'),
              isEditor: this._isEditor
            });
    ...
    value: function createHeaderElem(node) {
      var headerHtml = headerTemplate({ text: node.label });
      var headerElem = jQuery(headerHtml).addClass('header-level-' + node.tags.length);
...
var ScrollHelper = function () {
  ...
  _createClass(ScrollHelper, [{
    key: 'scrollToPage',
    value: function scrollToPage(pageNum) {
      var _this2 = this;

      var pageHeaderElem = this._nav.getPageElement(pageNum).find('.page-header');

      this.unbindScrollEvent();

      return new Promise(function (resolve, reject) {
        _this2._rootElem.scrollTo(pageHeaderElem, {
    ...
    value: function scrollToElem(annoElem, yOffsetIn) {
      ...
      return new Promise(function (resolve, reject) {
        _this3._rootElem.scrollTo(annoElem, {
          offset: {
            top: yOffset
          },
          onAfter: function onAfter() {
    ...
    key: 'scrollToAnnotation',
    value: function scrollToAnnotation(annotationId, yOffset) {
      ...
      try {
        for (var _iterator = this._listWidget.getAnnotationElems()[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
          var annoElem = _step.value;
    ...
    key: 'scrollDown',
    value: function scrollDown(delta) {
      this._rootElem.scrollTo('+=' + delta);
    }
  }, {
    key: 'scrollUp',
    value: function scrollUp(delta) {
      this._rootElem.scrollTo('-=' + delta);
    }
  }, {
    key: '_windBack',
    ...
    value: function bindScrollEvent() {
      ...
      if (this._continousPages) {
        this._rootElem.scroll(function () {
          var _ref = _asyncToGenerator(regeneratorRuntime.mark(function _callee(event) {
            var listWidget, elem, scrollTop, currentPos, contentHeight;
            return regeneratorRuntime.wrap(function _callee$(_context) {
              while (1) {
                switch (_context.prev = _context.next) {
                  case 0:
                    listWidget = _this._listWidget;
                    elem = jQuery(this);
                    ...
                    _context.next = 8;
                    return listWidget.loadPreviousPage();
                  ...
                  case 8:
                    ...
                    _context.next = 11;
                    return listWidget.loadNextPage();
...
// joosugi v0.3.1-4-gfccd1e3 built Mon Oct 16 2017 10:48:15 GMT-0400 (EDT)
